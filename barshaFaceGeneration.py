...
def create_model():
    ...
    model.add(Dense(17, activation='softmax')) ##since there are 15 categoies we need to write 15 categories here
...
def main():
    ...
    models.save("FaceRecognitionBarsha.h5")
...
if __name__ == '__main__':
    ...
    create_test_data(np.asarray(['subject17.pout.jpg']))
    ...
    reconstructed_model = tf.keras.models.load_model("FaceRecognitionBarsha.h5")
    predict = reconstructed_model.predict(normalized_X_Test)
